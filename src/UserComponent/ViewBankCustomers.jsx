...
const ViewBankCustomers = () => {
  ...
  const retrieveAllCustomers = async () => {
    const response = await axios.get(
      "https://bankapi.cohort5pod12.site/api/user/bank/customers?bankId=" + bank.bank.id,
      {
        headers: {
  ...
  const retrieveBankAllCustomerByName = async () => {
    const response = await axios.get(
      "https://bankapi.cohort5pod12.site/api/user/bank/customer/search?bankId=" +
        bank.bank.id +
        "&customerName=" +
        customerName,
      {
  ...
  const activateUser = (userId, e) => {
    ...
    fetch("https://bankapi.cohort5pod12.site/api/user/update/status", {
      method: "POST",
      headers: {
