    ...
    >
      ...
      <div
        style={{
          ...
          height: "70px",
          borderRadius: "50%",
          background: `linear-gradient(135deg, ${member.color} 30%, ${member.color}88 100%)`,
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              "radial-gradient(circle at 20% 50%, rgba(139,26,26,0.15) 0%, transparent 60%), radial-gradient(circle at 80% 20%, rgba(245,197,24,0.08) 0%, transparent 50%)",
            pointerEvents: "none",
          }}
        />
          ...
          {[
            {
              icon: "🎯",
              title: "Our Mission",
              text: "To deliver a secure, accessible, and seamless digital banking experience — empowering individuals and businesses to manage finances with confidence.",
            },
            {
              icon: "🔭",
              title: "Our Vision",
              text: "To become the most trusted digital financial services platform, setting a new standard for engineering excellence and customer-first design.",
            },
            {
              icon: "⚙️",
              title: "Our Approach",
              text: "We build with agility and precision — leveraging modern cloud infrastructure, rigorous testing, and collaborative engineering to ship fast without compromising quality or security.",
            },
            {
              icon: "🤝",
              title: "Our Values",
              text: "Integrity, innovation, and inclusion guide everything we do. Diverse perspectives and deep collaboration produce better products for every user.",
            },
          ].map((p) => (
            <div
              key={p.title}
            ...
            >
              ...
              <p style={{ color: "#555", fontSize: "0.91rem", lineHeight: "1.65", margin: 0 }}>
                {p.text}
              </p>
            </div>
          ))}
      ...
      <div style={{ background: "#f9f4ee", padding: "64px 32px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          />
          <p style={{ color: "#888", fontSize: "0.93rem", marginBottom: "36px" }}>
            14 engineers. One mission. Tap any card to call directly.
          </p>
      ...
      >
        <p style={{ fontSize: "0.85rem", color: "rgba(255,255,255,0.45)", letterSpacing: "2px", textTransform: "uppercase", marginBottom: "10px" }}>
          Get In Touch
        </p>
        <p style={{ fontSize: "1.15rem", color: "#f5c518", fontWeight: "600", margin: 0 }}>
          Every team member is one call away — we're always here to help.
        </p>
      </div>
    </div>
  );
