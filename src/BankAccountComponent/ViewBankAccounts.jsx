...
const ViewBankAccounts = () => {
  ...
  const retrieveAllAccounts = async () => {
    const response = await axios.get(
      "https://bankapi.cohort5pod12.site/api/bank/account/fetch/bankwise?bankId=" +
        bank.bank.id,
      {
        headers: {
  ...
  const retrieveAllAccountsByBankAccount = async () => {
    const response = await axios.get(
      "https://bankapi.cohort5pod12.site/api/bank/account/search?bankId=" +
        bank.bank.id +
        "&accountNumber=" +
        accountNumber,
      {
  ...
  const openAccount = (accountId, e) => {
    ...
    fetch("https://bankapi.cohort5pod12.site/api/bank/account/update/status", {
      method: "POST",
      headers: {
